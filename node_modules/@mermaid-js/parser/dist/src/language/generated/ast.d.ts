...
export interface TreemapDoc extends AstNode {
    readonly $type: 'TreemapDoc';
    accDescr?: string;
    accTitle?: string;
    title?: string;
    TreemapRows: Array<TreemapRow>;
}
export declare const TreemapDoc = "TreemapDoc";
export declare function isTreemapDoc(item: unknown): item is TreemapDoc;
export interface TreemapRow extends AstNode {
    readonly $container: TreemapDoc;
